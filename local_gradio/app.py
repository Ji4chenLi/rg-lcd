...
We provide models distilled from [Stable Diffusion 2.1](https://huggingface.co/stabilityai/stable-diffusion-2-1) and [Stable Diffusion 2.1-base](https://huggingface.co/stabilityai/stable-diffusion-2-1-base) with the reward feedback from [HPSv2.1](https://github.com/tgxs002/HPSv2/tree/master).

You can download the the models from [here](https://huggingface.co/jiachenli-ucsb) 🚀

Check out our [Project page](https://rg-lcd.github.io) 😄
"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Gradio demo for RG-LCM.")
    parser.add_argument(
        "--model_name",
        type=str,
        default="jiachenli-ucsb/RG-LCM-SD-2.1-768-HPSv2.1",
        help="Model name to load",
    )
    args = parser.parse_args()

    if "SD-2.1-base" in args.model_name:
